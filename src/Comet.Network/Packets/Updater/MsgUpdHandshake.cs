...
{
    public abstract class MsgUpdHandshake<T> : MsgBase<T>
    {
        protected MsgUpdHandshake()
        {
            
        }

        protected MsgUpdHandshake(BigInteger publicKey, BigInteger modulus, byte[] eIv, byte[] dIv)
        {
